...
if ($num>0)
{
	...
	echo "<br><br><form name='form2' method='post' action='update_math2.php'>
  <p>
    <label for='textfield'>Αρ. Μητρώου για διόρθωση:</label>
    <input type='text' name='code' >
  </p>
  

    <p>
    <label for='textfield'>Δώστε νέο τηλέφωνο:</label>
