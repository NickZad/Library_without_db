...
if ($num>0)
{
	...
	echo "<br><br><form name='form2' method='post' action='update_vil2.php'>
  <p>
    <label for='textfield'>Κωδικός βιβλίου για διόρθωση:</label>
    <input type='text' name='code' >
  </p>
  

    <p>
    <label for='textfield'>Δώστε νέα τιμή για ΣΥΝΟΛΟ:</label>
    <input type='text' name='timi' >
  </p>
  
  <p>
    <input type='submit' name='submit' id='submit' value='Ενημέρωση'>
  </p>
